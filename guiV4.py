...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(9, 130, 1091, 501))
        ...
        self.frame.setGeometry(QRect(9, 645, 1081, 41))
        ...
        self.widget.setGeometry(QRect(11, 11, 614, 25))
        self.horizontalLayout_2 = QHBoxLayout(self.widget)
        self.horizontalLayout_2.setSpacing(6)
        self.horizontalLayout_2.setContentsMargins(11, 11, 11, 11)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.carpetaChooser = QPushButton(self.widget)
        ...
        self.excel_anual_button = QPushButton(self.widget)
        ...
        self.widget1.setGeometry(QRect(9, 9, 1287, 102))
        self.horizontalLayout = QHBoxLayout(self.widget1)
        self.horizontalLayout.setSpacing(6)
        self.horizontalLayout.setContentsMargins(11, 11, 11, 11)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.header_cliente = QLabel(self.widget1)
        ...
        self.labelLogo = QLabel(self.widget1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"Huiini 1.8.3", None))
